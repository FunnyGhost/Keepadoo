...
describe('User Actions', () => {
  ...
  describe('MovieLists', () => {
    ...
    describe('LoadMovieListsFailed', () => {
      it('should create an action', () => {
        const payload = 'You failed!';
        const action = new fromUser.LoadMovieListsFailed(payload);
    ...
    describe('LoadDiscoverMoviesFailed', () => {
      it('should create an action', () => {
        const payload = 'You failed!';
        const action = new fromUser.LoadDiscoverMoviesFailed(payload);

        expect(action).toEqual({
          type: fromUser.UserActionTypes.LoadDiscoverMoviesFailed,
          payload
        });
      });
    });
  ...
  describe('TvShowLists', () => {
    ...
    describe('LoadTvShowListsFailed', () => {
      it('should create an action', () => {
        const payload = 'You failed!';
        const action = new fromUser.LoadTvShowListsFailed(payload);

        expect(action).toEqual({ type: fromUser.UserActionTypes.LoadTvShowListsFailed, payload });
      });
    });
